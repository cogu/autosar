...
* `RequirePortComSpec.make_from_port_interface`
...
* `ExternalTriggeringPointIdent.make_with_args`
* `ModeAccessPointIdent.make_with_args`
* `RunnableEntity.create_port_access`
* `RunnableEntity.create_internal_triggering_point`
* `DataReceiveErrorEvent.make`
* `DataReceivedEvent.make`
* `ExternalTriggerOccurredEvent.make`
* `OperationInvokedEvent.make`
* `SwcModeManagerErrorEvent.make`
* `SwcModeSwitchEvent.make`
* `InternalBehavior.create_constant_memory`
* `InternalBehavior.create_exclusive_area`
...
* `SwcInternalBehavior.create_external_trigger_event`
* `SwcInternalBehavior.create_internal_trigger_event`
* `SwcInternalBehavior.create_port_api_options`
