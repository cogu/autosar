...
class AtomicSoftwareComponent(AtomicSoftwareComponent):

    def tag(self,version=None): return 'ATOMIC-SOFTWARE-COMPONENT-TYPE' #if version>=4.0 else 'ATOMIC-SOFTWARE-COMPONENT-TYPE'
