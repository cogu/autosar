...
xml_to_enum_map = {
    ...
    'IdentifiableSubTypes': {
        'DATA-CONSTR': VersionedEnumValue(IdentifiableSubTypes.DATA_CONSTR, {50}),
        'SW-BASE-TYPE': VersionedEnumValue(IdentifiableSubTypes.SW_BASE_TYPE, {50}),
        'SW-ADDR-METHOD': VersionedEnumValue(IdentifiableSubTypes.SW_ADDR_METHOD, {50}),
    },
    'KeepWithPrevious': {
...
enum_to_xml_map = {
    ...
    'IdentifiableSubTypes': [
        VersionedTextValue('DATA-CONSTR', {50}),    # 0
        VersionedTextValue('SW-ADDR-METHOD', {50}),  # 1
        VersionedTextValue('SW-BASE-TYPE', {50}),   # 2
    ],
    'KeepWithPrevious': [
...
def enum_to_xml(enum_item: Enum, schema_version=DEFAULT_SCHEMA_VERSION):
    ...
    if isinstance(entry, VersionedTextValue):
        if schema_version not in entry.valid_versions:
