...
class IdentifiableSubTypes(Enum):
    ...
    CONSTANT_SPECIFICATION_MAPPING_SET = 30
    DATA_CONSTR = 31
    DATA_PROTOTYPE = 32
    DATA_RECEIVE_ERROR_EVENT = 33
    DATA_RECEIVED_EVENT = 34
...
xml_to_enum_map: dict[str, dict] = {
    ...
    "IdentifiableSubTypes": {
        ...
        "CONSTANT-SPECIFICATION-MAPPING-SET": IdentifiableSubTypes.CONSTANT_SPECIFICATION_MAPPING_SET,
...
enum_to_xml_map: dict[str, list] = {
    ...
    "IdentifiableSubTypes": [
        ...
        "CONSTANT-SPECIFICATION-MAPPING-SET",            # 30
        "DATA-CONSTR",                                   # 31
        "DATA-PROTOTYPE",                                # 32
        "DATA-RECEIVE-ERROR-EVENT",                      # 33
        "DATA-RECEIVED-EVENT",                           # 34
